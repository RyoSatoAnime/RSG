(() => {
  ...
  window.RCP_TABLES.cosmo_raiders = {
    ...
    walls: [
      ...
      { x1: 65, y1: 912, x2: 65, y2: 1077.5, r: 3 },
      { x1: 63, y1: 908, x2: 65, y2: 912, r: 3 },
      { x1: 675, y1: 1077.5, x2: 675, y2: 912, r: 3 },
    ...
    drainWalls: [
      {
        ...
        collisionSegments: [
          { x1: 65, y1: 1035.5, x2: 123.2, y2: 1069.6, r: 3 },
          { x1: 115.2, y1: 1078.5, x2: 107.2, y2: 1102.4, r: 3 }
        ]
      },
      {
        id: "drain_wall_right",
        ...
        collisionSegments: [
          { x1: 675, y1: 1035.5, x2: 616.8, y2: 1069.6, r: 3 },
          { x1: 624.8, y1: 1078.5, x2: 632.8, y2: 1102.4, r: 3 }
        ]
      }
    ],
